...
export function RoomDetailPage() {
  ...
  const [bookingPurposeType, setBookingPurposeType] = useState<'personal' | 'university' | 'committee'>('personal');
  ...
  const handleBookingSubmit = () => {
    if (bookingStep === 1) {
      ...
      setBookingPurposeType('personal');
    }
  };
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <Label>Booking Purpose Type *</Label>
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        <input
                          type="radio"
                          id="personal"
                          name="bookingPurposeType"
                          value="personal"
                          checked={bookingPurposeType === 'personal'}
                          onChange={(e) => setBookingPurposeType(e.target.value as 'personal' | 'university' | 'committee')}
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          name="bookingPurposeType"
                          value="university"
                          checked={bookingPurposeType === 'university'}
                          onChange={(e) => setBookingPurposeType(e.target.value as 'personal' | 'university' | 'committee')}
                          className="w-4 h-4 text-primary border-gray-300 focus:ring-primary"
                        />
                        <label
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          name="bookingPurposeType"
                          value="committee"
                          checked={bookingPurposeType === 'committee'}
                          onChange={(e) => setBookingPurposeType(e.target.value as 'personal' | 'university' | 'committee')}
                          className="w-4 h-4 text-primary border-gray-300 focus:ring-primary"
                        />
                        <label
